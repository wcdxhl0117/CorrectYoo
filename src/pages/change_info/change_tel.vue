...
export default {
    ...
    mounted() {
        this.$http.post('/ycorrect/user/center/getMobileAuth', {}, {}).then(response => {
    ...
    methods: {
        getCode() {
            ...
            if (!/^[1][3,4,5,6,7,8][0-9]{9}$/.test(this.tel)) {
                ...
                // 获取后台验证码
                this.$http.post('/ycorrect/user/center/sendMobileAuthCode', {}, {
                    params: {}
                }).then(response => {
        ...
        submitAction() {
            let _this = this
            // 验证二维码
            this.$http.post('/ycorrect/user/center/checkMobileVerifyCode', {}, {
                params: {
